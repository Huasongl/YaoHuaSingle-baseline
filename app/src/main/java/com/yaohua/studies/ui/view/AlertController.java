...
public class AlertController {
    ...
    public AlertController(Context context, AppCompatDialog di, Window window) {
        ...
        //todo lgy
        mAlertDialogLayout = R.layout.vivo_abc_alert_dialog_material;
        mButtonPanelSideLayout = 0;

        mListLayout = R.layout.vivo_abc_select_dialog_material;
        mMultiChoiceItemLayout = R.layout.vivo_select_dialog_multichoice_material;
        mSingleChoiceItemLayout = R.layout.vivo_select_dialog_singlechoice_material;
        mListItemLayout = R.layout.vivo_select_dialog_item_material;
        mShowTitle = true;
        float scale = context.getResources().getDisplayMetrics().density;
        mButtonIconDimen = (int)(48 * scale + 0.5F);
    ...
    private void setupButtons(ViewGroup buttonPanel) {
        ...
        boolean showTopSpace = false;
        View space1 = buttonPanel.findViewById(R.id.button1_space);
        ...
        View space3 = buttonPanel.findViewById(R.id.button3_space);
        ...
        View spaceTop = buttonPanel.findViewById(R.id.button1_space);
        spaceTop.setVisibility(showTopSpace ? View.VISIBLE : View.GONE);
...
//                    R.styleable.RecycleListView_paddingTopNoTitle, -1);
            //todo lgy
            float scale = context.getResources().getDisplayMetrics().density;
            mPaddingBottomNoButtons = (int)(8 * scale + 0.5F);
            mPaddingTopNoTitle = (int)(8 * scale + 0.5F);
        }
