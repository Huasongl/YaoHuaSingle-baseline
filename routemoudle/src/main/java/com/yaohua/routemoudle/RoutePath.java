...
public class RoutePath {
    ...
    public static final String AUDIO_BOOK_DETAIL = "/audioBookModule/audioBookDetailPage"; //听书详情页
    public static final String AUDIO_BOOK_CLASSIFY = "/audioBookModule/classify";  //听书分类
